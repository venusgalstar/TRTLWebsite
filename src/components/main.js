            ...
            <div className="wrap">
                <div className="main-left aos-init aos-animate" data-aos="fade-up">
                    ...
                    <p className="main-decs">
                        ...
                        We're thrilled to present TRTLCoin, the latest addition to the meme token universe!
                        Born out of a commitment to infuse joy and humor into the cryptocurrency landscape,
                        TRTLCoin is more than just a token; it's a celebration of laughter, creativity, and community spirit.
                    </p>
